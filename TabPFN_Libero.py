...
import imageio
import numpy as np
import libero.lifelong

from tabpfn import TabPFNRegressor
from libero.libero import benchmark, get_libero_path
from libero.libero.envs import OffScreenRenderEnv
from libero.libero.utils.download_utils import libero_dataset_download, check_libero_dataset


def extract(task_suite, task_id):

    demo_path = task_suite.get_task_demonstration(task_id)  
    full_path = os.path.join("/home/dskinner2/repo/tabpi/.venv/lib/python3.13/site-packages/libero/datasets", 
                             demo_path) 
...
def main():
    ...
    #Fit the model here
    n_train = int(features.shape[0] * .80)
